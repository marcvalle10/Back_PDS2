...
CREATE TABLE IF NOT EXISTS periodo (
  id           SERIAL PRIMARY KEY,
  anio         INT NOT NULL,
  ciclo        INT NOT NULL, -- 1=Ene-Jun, 2=Ago-Dic (o similar)
...
-- =========================
-- Asignación docente y optativas
-- =========================
...
-- =========================
-- Cargas, validaciones y auditoría
-- =========================
...
CREATE INDEX IF NOT EXISTS ix_archivo_tipo_fecha ON archivo_cargado (tipo, fecha);
